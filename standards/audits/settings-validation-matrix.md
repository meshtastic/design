...
| Bluetooth Config | ✅ | ✅ | Fixed-PIN leading-zero bug fixed in Apple PR [#1830](https://github.com/meshtastic/Meshtastic-Apple/pull/1830) |
...
| Field | Android | Apple | Discrepancy |
|-------|---------|-------|-------------|
| `fixed_pin` | Exactly 6 digits | Exactly 6 digits, strips leading zeros only (`.drop(while: { $0 == "0" })`) | ✅ **Fixed in Apple PR [#1830](https://github.com/meshtastic/Meshtastic-Apple/pull/1830)** (merged May 17, 2026) — only leading zeros stripped; interior zeros like `100200` preserved correctly. |
