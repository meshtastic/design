...
| [#99](https://github.com/meshtastic/design/issues/99) | Units, Measurement & Locale | Follow OS Language & Region for all convertible units; no in-app unit controls (Apple reference implementation); wind speed = locale-driven (decided May 17) | Android had open request for in-app wind speed selector ([#87](https://github.com/meshtastic/design/issues/87), now closed) | §5 Vision-Centric (native OS patterns), §6 IA (plain language, localization) | ✅ OS locale delegation aligns with §5 native patterns and §6; Apple PRs [#1764](https://github.com/meshtastic/Meshtastic-Apple/pull/1764) (fix measurement/locale), [#1766](https://github.com/meshtastic/Meshtastic-Apple/pull/1766) (user guide), and [#1767](https://github.com/meshtastic/Meshtastic-Apple/pull/1767) (developer guide) merged May 9–10. Apple implementation substantially complete. |
| [#84](https://github.com/meshtastic/design/issues/84) _(tracked by [#99](https://github.com/meshtastic/design/issues/99))_ | SI prefixes for large environment metric values | Use intelligent SI prefixes — e.g. 18.2A not 18200mA, 32.1m not 32100mm; contributor @NeimadTL assigned | — | §5 Vision-Centric (readability), §6 IA (plain language) | ✅ Aligns with §5/§6; sub-issue of Units & Measurement — cross-platform standard should be defined under [#99](https://github.com/meshtastic/design/issues/99) | **In Progress** |
| [#100](https://github.com/meshtastic/design/issues/100) | "Translate this message" cross-platform standard | Context menu entry point; on-device OS translation API; translated text persisted and toggleable (iOS reference implementation via Apple Translation framework, iOS 17.4+) | Android (#83) proposed action bar icon; community divided on engine choice (OS-level vs. ML Kit) and persistence model | §3 Dynamic Layout (hide action when unavailable), §4 Iconography (icon+text redundancy), §6 IA (plain language labels) | ⚠️ §3/§4/§6 all partially apply; Apple PRs [#1785](https://github.com/meshtastic/Meshtastic-Apple/pull/1785), [#1787](https://github.com/meshtastic/Meshtastic-Apple/pull/1787), [#1792](https://github.com/meshtastic/Meshtastic-Apple/pull/1792) merged (iOS 26 Translation framework, availability-gated). 4 open Android alignment questions remain. | **Needs Discussion** |
...
- **#99:** Wind speed is locale-driven — decided May 17, 2026; #87 closed. Apple PRs [#1764](https://github.com/meshtastic/Meshtastic-Apple/pull/1764)/[#1766](https://github.com/meshtastic/Meshtastic-Apple/pull/1766)/[#1767](https://github.com/meshtastic/Meshtastic-Apple/pull/1767) merged May 9–10 — Apple implementation substantially complete. Sub-issue [#84](https://github.com/meshtastic/design/issues/84) (SI prefixes for large env values — e.g. 18.2A not 18200mA) is in progress under this umbrella. Four questions remain open for cross-platform alignment: natural scaling thresholds, hPa as fixed pressure unit, in-app selector edge cases, and relative time vs absolute timestamp for last-heard.
- **#100:** Apple PRs [#1785](https://github.com/meshtastic/Meshtastic-Apple/pull/1785)/[#1787](https://github.com/meshtastic/Meshtastic-Apple/pull/1787)/[#1792](https://github.com/meshtastic/Meshtastic-Apple/pull/1792) merged — Apple Translation framework fully implemented with iOS 26 availability guard, long-press context menu, persisted toggle between original/translated text. Tracks #83 (Android feature request). Four open questions for Android alignment remain: engine choice (OS-level vs. ML Kit), persistence model, availability gating strategy, and language direction control.
...
| [#84](https://github.com/meshtastic/design/issues/84) | SI prefixes for env metrics | enhancement | Strong | §5, §6 | ✅ | In Progress (tracked under [#99](https://github.com/meshtastic/design/issues/99)) |
